...
# STEP 1 + STEP 2: AI Surrogate Model Dataset Preparation
...
# Update this path to where your CSV is stored locally
...
# ✅ STEP 1.3: Encode Material as numeric values
material_map = {
    "Aluminium": 0,
    "Steel": 1,
...
# ✅ STEP 1.4: Split into features (X) and targets (Y)
